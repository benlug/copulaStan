...
The `copulaStan` package fits bivariate Gaussian, Clayton, and Joe
copula models using Stan. It supports normal, lognormal, exponential,
and beta marginal distributions with full Bayesian inference via
`cmdstanr`.

## Prerequisites

`copulaStan` requires [CmdStan](https://mc-stan.org/cmdstanr/) to be
installed:
...
[GitHub](https://github.com/benlug/copulaStan):
...
Fit a bivariate Gaussian copula model with normal and lognormal
marginals:
